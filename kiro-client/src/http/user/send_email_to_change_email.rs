...
/// use http::HeaderMap;
/// use kiro_client::{ClientService, send_email_to_change_email::send_email_to_change_email, SessionModel};
...
///     send_email_to_change_email(&service, &session).await;
///
...
#[utoipa::path(
    get,
    path = "/user/send_email_to_change_email",
    tag = "user",
    responses(
